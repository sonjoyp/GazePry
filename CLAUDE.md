...
npm run d7:stimuli             # regenerate stimulus PNGs
...
### D7 stimuli are manifest-driven
...
cannot drift. Generated by `scripts/make_stimuli.py`. E1 ships 24 generated
fractals (abstract *on purpose*: E1's validity requires no prior exposure);
E2/E3 ship placeholders and the task page **disables Begin** while a set
contains them.
